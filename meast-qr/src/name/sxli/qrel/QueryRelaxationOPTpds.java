...
/**
 * the optimized polynomial-time algorithm,using heuristic related to degree of vertex and step to reach certificate.
 */
public class QueryRelaxationOPTpds implements IQueryRelaxation {
